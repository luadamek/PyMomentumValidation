...
input_files = ["/project/def-psavard/ladamek/momentumvalidationoutput/Nov19_nocalib/Output.root", "/project/def-psavard/ladamek/momentumvalidationoutput/Nov19_calib/Output.root"]
...
for input_file, output_location in zip(input_files, output_locations):
    ...
    for name in ["poslead", "neglead"]:
       ...
       hist_name = histogram_name_base.format(identified = name)
